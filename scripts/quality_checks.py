...
CRITICAL_FILES = [
    ...
    PROCESSED_DIR / "final" / "security_issuance_yields.csv",
]
...
def build_quality_report():
    ...
    checks.append(check_required_columns(PROCESSED_DIR / "final" / "security_issuance_yields.csv", ["date", "series_key", "value_percent"], "critical"))
